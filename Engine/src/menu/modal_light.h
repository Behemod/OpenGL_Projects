...
void Menu::light_tab(std::shared_ptr<Light> light)//меняем тут позицию и яркость света
{
	...
	{
		scene_->get_light()->set_pos(glm::vec3(lightPosV[0], lightPosV[1], lightPosV[2]));
	}
}
